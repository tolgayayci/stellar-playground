...
const RESOURCES = [
  {
    ...
    description: "Writing Your First Soroban Contract in Rust",
  ...
  },
  {
    ...
    description: "Stellar Protocol Documentation & Soroban SDK Reference",
  ...
  },
  {
    ...
    description: "Join the Stellar Developer Discord Community",
    ...
    <section className="container mx-auto py-24 lg:py-32">
      ...
      >
        ...
        <p className="text-lg text-muted-foreground">
          Everything you need to get started with Stellar development
        </p>
      </motion.div>
