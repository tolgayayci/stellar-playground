...
const USER_TYPES = [
  {
    ...
    benefits: [
      ...
      },
      {
        ...
        description: 'Built-in Stellar testnet accounts for seamless deployment.',
      },
      {
        icon: Share2,
  ...
  },
  {
    id: 'newbies',
    icon: GraduationCap,
    title: 'Stellar Beginners',
    description: 'Start your Stellar journey with a guided, hassle-free experience.',
    benefits: [
      {
        icon: BookOpen,
  ...
  },
  {
    ...
    description: 'Streamlined environment for efficient Stellar development.',
    benefits: [
      {
        icon: Rocket,
    ...
    <section className="container mx-auto py-24 lg:py-32">
      ...
      >
        <h2 className="text-3xl font-bold tracking-tight mb-4">
          Who Can Use Stellar Playground?
        </h2>
