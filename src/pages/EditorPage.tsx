...
import { FileCode2, Terminal, PlayCircle, Wand2, Clock, Calendar, Pencil, Check, X, Bug } from 'lucide-react';
...
export function EditorPage() {
  ...
  const handleRequestDeploy = () => {
    ...
    if (lastCompilationResult?.success && lastCompilationResult?.abi) {
      ...
      // Check for Stellar's official contract spec format
  ...
  const handleReportIssue = () => {
    window.open('https://github.com/tolgayayci/stellar-playground/issues/new?labels=bug&template=bug_report.md', '_blank');
  };
